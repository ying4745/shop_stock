...
# 关注中的人数查询URL
MY_FOLLOWING_COUNT_URL = 'https://seller.my.shopee.cn/api/v2/users/131874780/'
...
# 关注中的人数查询URL
PH_FOLLOWING_COUNT_URL = 'https://seller.ph.shopee.cn/api/v2/users/141273961/'
# 关注中的列表
...
# 关注中的人数查询URL
TH_FOLLOWING_COUNT_URL = 'https://seller.th.shopee.cn/api/v2/users/151141788/'
# 关注中的列表
...
# 关注中的人数查询URL
ID_FOLLOWING_COUNT_URL = 'https://seller.id.shopee.cn/api/v2/users/173721950/'
# 关注中的列表
